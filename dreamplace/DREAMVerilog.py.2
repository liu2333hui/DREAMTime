...
def place(params):
    ...
    timer = Timer(placedb, params) 

    #print(placedb.net_names)
    #print(placedb.net_weights)
    #print(placedb.net2pin_map)
    #print(placedb.pin2node_map)
    #print(placedb.net_name2id_map)
    #print(placedb.node_names)
    #print(placedb.node_x)
    #print(placedb.node_y)
    #import sys
    #sys.exit()
    #use timing-driven weights
    if (params.timing_driven):
        placedb.net_weights = np.array(timer.weights , dtype=np.float32)
    ...
    #Final Timing check
    print("FINAL TIMING CHECK")
    timer.getFinalTiming()
